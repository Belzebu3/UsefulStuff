...
- Fully customizable: text, font, size, and position
...
- Configurable font, size, border, background texture, and anchor position
...
- World of Warcraft Retail (Interface version 120000)
